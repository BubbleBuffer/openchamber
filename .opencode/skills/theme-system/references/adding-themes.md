...
Add to `packages/web/src/ui/lib/theme/themes/`:
- `<id>-light.json`
- `<id>-dark.json`
...
- Presets: `packages/web/src/ui/lib/theme/themes/presets.ts`
- Example: `packages/web/src/ui/lib/theme/themes/flexoki-dark.json`
