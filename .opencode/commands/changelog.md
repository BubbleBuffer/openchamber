...
- User-facing and benefit-oriented; avoid internal component names unless users see them (ex: "Web app", "Mobile/PWA").
- Prefer 5-9 bullets; group by area only if it reads better.
...
- Use area prefixes when helpful for grouping (e.g., "Chat:", "Settings:", "Git:", "Terminal:", "Mobile:", "UI:").
...
Now:
1) Propose the new `[Unreleased]` bullet list for @CHANGELOG.md.
2) Edit @CHANGELOG.md to update its `[Unreleased]` section.
