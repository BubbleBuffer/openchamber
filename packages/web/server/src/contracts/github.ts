...
export const GITHUB_ERROR_CODES = [
  ...
  "github_not_connected", "github_repo_unavailable", "github_device_flow_failed", "github_upstream_error", "github_internal_error",
] as const;
...
export type GitHubAuthStatus = { connected: false; accounts?: GitHubAuthAccount[] } | { connected: true; user: GitHubUserSummary | null; scope?: string; accounts?: GitHubAuthAccount[] };
...
export type GitHubIssueGetResult = { connected: false } | { connected: true; repo: GitHubRepoRef | null; issue: GitHubIssue | null };
export type GitHubIssueCommentsResult = { connected: false } | { connected: true; repo: GitHubRepoRef | null; comments: GitHubIssueComment[] };
