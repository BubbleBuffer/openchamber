...
import { SKILLS_ERROR_CODES, parseSkillsFailure, parseSkillsListResponse, skillsError } from "./skills.js";
...
const parserMatrix: readonly MatrixRow[] = [
  ...
  { domain: "skills", success: [parseSkillsListResponse, { skills: [] }], invalid: [parseSkillsListResponse, {}], authorization: commonError("unauthorized"), internal: [parseSkillsFailure, skillsError("skills_internal_error")], partial: [parseSkillsListResponse, { skills: [] }] },
