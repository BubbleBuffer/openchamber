import type { TunnelProvider, TunnelProviderCapabilities } from "./types.js";
...
export function createTunnelProviderRegistry(initialProviders: TunnelProvider[] = []): TunnelProviderRegistry {
