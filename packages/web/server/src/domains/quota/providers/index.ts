...
import type { ConfiguredProviderEntry, QuotaProviderResult } from "../types.js";
...
export async function fetchQuotaForProvider(providerId: string): Promise<QuotaProviderResult> {
