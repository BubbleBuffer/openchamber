...
export type GitRunResultType = GitRunResult | GitRunError;

export async function runGit(
  args: string[],
  options: GitRunOptions = {}
): Promise<GitRunResultType> {
...
export async function assertGitAvailable(): Promise<
  { ok: true } | { ok: false; error: { kind: "gitUnavailable"; message: string } }
> {
