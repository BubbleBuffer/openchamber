...
export const NotificationSettings: React.FC = () => {
  ...
  const setNotificationMode = useNotificationSettingsStore(state => state.setNotificationMode);
  const notifyOnSubtasks = useNotificationSettingsStore(state => state.notifyOnSubtasks);
  const setNotifyOnSubtasks = useNotificationSettingsStore(state => state.setNotifyOnSubtasks);
  const notifyOnCompletion = useNotificationSettingsStore(state => state.notifyOnCompletion);
  const setNotifyOnCompletion = useNotificationSettingsStore(state => state.setNotifyOnCompletion);
  const notifyOnError = useNotificationSettingsStore(state => state.notifyOnError);
  const setNotifyOnError = useNotificationSettingsStore(state => state.setNotifyOnError);
  const notifyOnQuestion = useNotificationSettingsStore(state => state.notifyOnQuestion);
  const setNotifyOnQuestion = useNotificationSettingsStore(state => state.setNotifyOnQuestion);
  const notificationTemplates = useNotificationSettingsStore(state => state.notificationTemplates);
  const setNotificationTemplates = useNotificationSettingsStore(state => state.setNotificationTemplates);
  const summarizeLastMessage = useNotificationSettingsStore(state => state.summarizeLastMessage);
  const setSummarizeLastMessage = useNotificationSettingsStore(state => state.setSummarizeLastMessage);
  const summaryThreshold = useNotificationSettingsStore(state => state.summaryThreshold);
  const setSummaryThreshold = useNotificationSettingsStore(state => state.setSummaryThreshold);
  const summaryLength = useNotificationSettingsStore(state => state.summaryLength);
  const setSummaryLength = useNotificationSettingsStore(state => state.setSummaryLength);
  const maxLastMessageLength = useNotificationSettingsStore(state => state.maxLastMessageLength);
  const setMaxLastMessageLength = useNotificationSettingsStore(state => state.setMaxLastMessageLength);
