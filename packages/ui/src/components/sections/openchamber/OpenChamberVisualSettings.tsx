...
export const OpenChamberVisualSettings: React.FC<OpenChamberVisualSettingsProps> = ({ visibleSettings }) => {
    ...
    const showReasoningTraces = useChatRenderingStore(state => state.showReasoningTraces);
    const setShowReasoningTraces = useChatRenderingStore(state => state.setShowReasoningTraces);

    const mermaidRenderingMode = useChatRenderingStore(state => state.mermaidRenderingMode);
    const setMermaidRenderingMode = useChatRenderingStore(state => state.setMermaidRenderingMode);
    const userMessageRenderingMode = useChatRenderingStore(state => state.userMessageRenderingMode);
    const setUserMessageRenderingMode = useChatRenderingStore(state => state.setUserMessageRenderingMode);
    const stickyUserHeader = useChatRenderingStore(state => state.stickyUserHeader);
    const setStickyUserHeader = useChatRenderingStore(state => state.setStickyUserHeader);
    const chatRenderMode = useChatRenderingStore(state => state.chatRenderMode);
    const setChatRenderMode = useChatRenderingStore(state => state.setChatRenderMode);
    const activityRenderMode = useChatRenderingStore(state => state.activityRenderMode);
    const setActivityRenderMode = useChatRenderingStore(state => state.setActivityRenderMode);
    const fontSize = useVisualPreferencesStore(state => state.fontSize);
    const setFontSize = useVisualPreferencesStore(state => state.setFontSize);
    const terminalFontSize = useVisualPreferencesStore(state => state.terminalFontSize);
    const setTerminalFontSize = useVisualPreferencesStore(state => state.setTerminalFontSize);
    const padding = useVisualPreferencesStore(state => state.padding);
    const setPadding = useVisualPreferencesStore(state => state.setPadding);
    const inputBarOffset = useVisualPreferencesStore(state => state.inputBarOffset);
    const setInputBarOffset = useVisualPreferencesStore(state => state.setInputBarOffset);
    const diffLayoutPreference = useDiffPreferencesStore(state => state.diffLayoutPreference);
    const setDiffLayoutPreference = useDiffPreferencesStore(state => state.setDiffLayoutPreference);
    ...
    const setShowToolFileIcons = useChatRenderingStore(state => state.setShowToolFileIcons);
    const showExpandedBashTools = useChatRenderingStore(state => state.showExpandedBashTools);
    const setShowExpandedBashTools = useChatRenderingStore(state => state.setShowExpandedBashTools);
    const showExpandedEditTools = useChatRenderingStore(state => state.showExpandedEditTools);
    const setShowExpandedEditTools = useChatRenderingStore(state => state.setShowExpandedEditTools);
    ...
    const hasAppearanceSettings = shouldShow('theme') || shouldShow('pwaInstallName') || shouldShow('pwaOrientation') || shouldShow('timeFormat') || shouldShow('weekStart');
