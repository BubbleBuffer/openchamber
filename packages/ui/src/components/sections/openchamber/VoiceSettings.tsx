...
export const VoiceSettings: React.FC = () => {
    ...
    const setVoiceProvider = useVoiceSettingsStore((state) => state.setVoiceProvider);
    const speechRate = useVoiceSettingsStore((state) => state.speechRate);
    const setSpeechRate = useVoiceSettingsStore((state) => state.setSpeechRate);
    const speechPitch = useVoiceSettingsStore((state) => state.speechPitch);
    const setSpeechPitch = useVoiceSettingsStore((state) => state.setSpeechPitch);
    const speechVolume = useVoiceSettingsStore((state) => state.speechVolume);
    const setSpeechVolume = useVoiceSettingsStore((state) => state.setSpeechVolume);
    const sayVoice = useVoiceSettingsStore((state) => state.sayVoice);
    const setSayVoice = useVoiceSettingsStore((state) => state.setSayVoice);
    const browserVoice = useVoiceSettingsStore((state) => state.browserVoice);
    const setBrowserVoice = useVoiceSettingsStore((state) => state.setBrowserVoice);
    const openaiVoice = useVoiceSettingsStore((state) => state.openaiVoice);
    const setOpenaiVoice = useVoiceSettingsStore((state) => state.setOpenaiVoice);
    const openaiApiKey = useVoiceSettingsStore((state) => state.openaiApiKey);
    const setOpenaiApiKey = useVoiceSettingsStore((state) => state.setOpenaiApiKey);
    const openaiCompatibleUrl = useVoiceSettingsStore((state) => state.openaiCompatibleUrl);
    const setOpenaiCompatibleUrl = useVoiceSettingsStore((state) => state.setOpenaiCompatibleUrl);
    const openaiCompatibleVoice = useVoiceSettingsStore((state) => state.openaiCompatibleVoice);
    const setOpenaiCompatibleVoice = useVoiceSettingsStore((state) => state.setOpenaiCompatibleVoice);
    const openaiCompatibleTtsModel = useVoiceSettingsStore((state) => state.openaiCompatibleTtsModel);
    const setOpenaiCompatibleTtsModel = useVoiceSettingsStore((state) => state.setOpenaiCompatibleTtsModel);
    ...
    const setSttProvider = useVoiceSettingsStore((state) => state.setSttProvider);
    const sttServerUrl = useVoiceSettingsStore((state) => state.sttServerUrl);
    const setSttServerUrl = useVoiceSettingsStore((state) => state.setSttServerUrl);
    const sttModel = useVoiceSettingsStore((state) => state.sttModel);
    const setSttModel = useVoiceSettingsStore((state) => state.setSttModel);
    const sttLanguage = useVoiceSettingsStore((state) => state.sttLanguage);
    const setSttLanguage = useVoiceSettingsStore((state) => state.setSttLanguage);
    const sttSilenceThresholdDb = useVoiceSettingsStore((state) => state.sttSilenceThresholdDb);
    const setSttSilenceThresholdDb = useVoiceSettingsStore((state) => state.setSttSilenceThresholdDb);
    const sttSilenceHoldMs = useVoiceSettingsStore((state) => state.sttSilenceHoldMs);
    const setSttSilenceHoldMs = useVoiceSettingsStore((state) => state.setSttSilenceHoldMs);
    const setShowMessageTTSButtons = useVoiceSettingsStore((state) => state.setShowMessageTTSButtons);
    const voiceModeEnabled = useVoiceSettingsStore((state) => state.voiceModeEnabled);
    const setVoiceModeEnabled = useVoiceSettingsStore((state) => state.setVoiceModeEnabled);
    const summarizeMessageTTS = useVoiceSettingsStore((state) => state.summarizeMessageTTS);
    const setSummarizeMessageTTS = useVoiceSettingsStore((state) => state.setSummarizeMessageTTS);
    const summarizeVoiceConversation = useVoiceSettingsStore((state) => state.summarizeVoiceConversation);
    const setSummarizeVoiceConversation = useVoiceSettingsStore((state) => state.setSummarizeVoiceConversation);
    const summarizeCharacterThreshold = useVoiceSettingsStore((state) => state.summarizeCharacterThreshold);
    const setSummarizeCharacterThreshold = useVoiceSettingsStore((state) => state.setSummarizeCharacterThreshold);
    const summarizeMaxLength = useVoiceSettingsStore((state) => state.summarizeMaxLength);
    const setSummarizeMaxLength = useVoiceSettingsStore((state) => state.setSummarizeMaxLength);
