...
import { useGitBranchLabel } from '@/stores/git/useGitStore';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  const openContextOverview = useContextPanelStore((state) => state.openContextOverview);
  const openContextPlan = useContextPanelStore((state) => state.openContextPlan);
  const closeContextPanel = useContextPanelStore((state) => state.closeContextPanel);
  const contextPanelByDirectory = useContextPanelStore((state) => state.contextPanelByDirectory);
