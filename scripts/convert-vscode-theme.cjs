 ...
 *      packages/web/src/ui/lib/theme/themes/<theme-id>.json
 ...
 * 
 * OUTPUT:
 *   - Theme file: packages/web/src/ui/lib/theme/themes/<theme-name>-<variant>.json
 *   - Updated: packages/web/src/ui/lib/theme/themes/presets.ts
 * 
 * COMPATIBILITY:
